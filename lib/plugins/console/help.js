...
function printHelpForCommand(command, func){

    var options = func.options;

    console.log('Usage: sorest', command, options.usage || '');
    console.log('\nDescription:');
    console.log((options.description || options.desc || func.description || func.desc) + '\n');
